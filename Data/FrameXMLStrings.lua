-- Generated from /Users/macos/Desktop/FrameXML/GlobalStrings.lua
EpochCN_FrameXMLStrings = {
  ["ABANDON_PET"] = "你是否决定永远地遗弃你的宠物？",
  ["ABANDON_QUEST"] = "放弃任务",
  ["ABANDON_QUEST_ABBREV"] = "放弃",
  ["ABANDON_QUEST_CONFIRM"] = "放弃\\",
  ["ABANDON_QUEST_CONFIRM_WITH_ITEMS"] = "确定要放弃\\",
  ["ABILITIES"] = "技能",
  ["ABSORB"] = "吸收",
  ...
  ["CHAT_ANNOUNCE_GET"] = "[%s]: %s",
  ["CHAT_ANNOUNCE_SEND"] = "[%s]: %s",
  ["CHAT_AUTO_JOIN"] = "自动加入",
  ["CHAT_BAN"] = "禁止进入",
  ...
  ["CHAT_MSG_BG_SYSTEM_ALLIANCE"] = "战场（联盟）",
  ["CHAT_MSG_BG_SYSTEM_HORDE"] = "战场（部落）",
  ["CHAT_MSG_BG_SYSTEM_NEUTRAL"] = "战场（中立）",
  ["CHAT_MSG_BN_CONVERSATION"] = "实名对话",
  ["CHAT_MSG_BN_WHISPER"] = "实名好友密语",
  ["CHAT_MSG_CHANNEL_LIST"] = "频道列表",
  ["CHAT_MSG_COMBAT_FACTION_CHANGE"] = "声望",
  ["CHAT_MSG_COMBAT_HONOR_GAIN"] = "荣誉获取",
  ["CHAT_MSG_COMBAT_MISC_INFO"] = "战斗信息",
  ["CHAT_MSG_COMBAT_XP_GAIN"] = "经验获取",
  ["CHAT_MSG_EMOTE"] = "表情",
  ...
  ["DEFAULT_STATDEFENSE_TOOLTIP"] = "防御等级%d（+%d 防御）|n躲闪、格挡和招架几率提高%.2f%%|n被命中和被爆击的几率降低|n|cff888888（在效果递减之前）|r",
  ...
  ["ERR_ARENA_TEAM_NAME_EXISTS_S"] = "竞技场战队名\\",
  ...
  ["ERR_EQUIP_TRADESKILL"] = "你还不具备装备这件物品的专业技能。",
  ...
  ["ERR_FRIEND_ONLINE_SS"] = "|Hplayer:%s|h[%s]|h已经上线了。",
  ...
  ["ERR_GUILD_NOT_IN_GUILD"] = "你没有加入任何公会。",
  ...
  ["ERR_MAIL_ATTACHMENT_ITEM_COUNT"] = "你不能附带那么多物品。",
  ...
  ["ERR_SPELL_IN_PROGRESS"] = "另一个法术正在施放中",
  ["ERR_SPELL_LEARNED_S"] = "你学会了一个新法术：%s。",
  ...
  ["GLYPH_MINOR"] = "小型雕文",
  ["GLYPH_PRIME"] = "主要雕文",
  ["GLYPH_SLOT_LOCKED"] = "此雕文槽锁定",
  ["GLYPH_SLOT_LOCKED_TOOLTIP"] = "升至 %d 级时解锁。",
  ...
  ["MOVIE_RECORDING_COMPRESSION_STARTED"] = "已开始压缩视频\\",
  ...
  ["MOVIE_RECORDING_RECORDING_STARTED"] = "已开始录制视频\\",
  ["MOVIE_RECORDING_RECORDING_STOPPED"] = "已停止录制视频\\",
  ...
  ["NEW_LEADER"] = "新的领袖",
  ["NEW_SKILL_LEARNED"] = "新技能已学会",
  ["NEW_TITLE_EARNED"] = "你获得了'%s'的头衔。",
  ["NEXT"] = "下一页",
  ["NEXT_ABILITY"] = "下一个技能",
  ["NEXT_BATTLE"] = "下一场战斗：%1$02d:%2$02d:%3$02d",
  ["NEXT_SPELL_RANK_AVAILABLE_LEVEL"] = "下一等级需要达到 %d 级",
  ["NO"] = "否",
  ["NONE"] = "无",
  ["NONEQUIPSLOT"] = "已制造物品",
  ["NONE_CAPS"] = "无",
  ...
  ["OPTION_TOOLTIP_ASSIST_ATTACK"] = "自动攻击使用\\",
  ...
  ["PET_HAPPINESS2"] = "满足",
  ["PET_HAPPINESS3"] = "快乐",
  ["PET_HAPPINESS_TOOLTIP"] = "你的宠物处于%s状态，这意味着它的伤害为基础值的%d%%。",
  ["PET_INFO"] = "宠物信息",
  ["PET_MODE_AGGRESSIVE"] = "攻击型",
  ["PET_MODE_DEFENSIVE"] = "防御型",
  ["PET_MODE_PASSIVE"] = "被动型",
  ["PET_NAME_NUMBER"] = "宠物 %d：%s",
  ...
  ["PET_STABLE_EMPTY_SLOT"] = "空闲栏",
  ["PET_STABLE_TITLE"] = "宠物寄养",
  ["PET_STAY"] = "命令宠物等候",
  ...
  ["SPELL_CAST_TIME_SEC_NONE"] = "%.2g秒",
  ["SPELL_COLOR_BY_SCHOOL_COMBATLOG_TOOLTIP"] = "按类型用彩色标记法术名。",
  ["SPELL_COOLDOWN_REMAINING"] = "冷却剩余",
  ["SPELL_COST_ENERGY"] = "%d 能量",
  ["SPELL_COST_HEALTH"] = "%d%% 生命值",
  ["SPELL_COST_MANA"] = "%d 法力值",
  ["SPELL_COST_RAGE"] = "%d 怒气",
  ["SPELL_COST_RUNE"] = "%d %s",
  ["SPELL_COST_RUNIC_POWER"] = "%d 符文之力",
  ["SPELL_CREATE_COMBATLOG_TOOLTIP"] = "当法术或技能制造出物体时显示信息。",
  ["SPELL_CRIT_CHANCE"] = "法术暴击率",
  ["SPELL_DAMAGE"] = "法术伤害",
  ...
  ["SPELL_FAILED_ALREADY_MOUNTED"] = "你已经骑乘了",
  ...
  ["SPELL_RANK"] = "等级",
  ["SPELL_RANK_HEADER"] = "等级 %d",
  ["SPELL_REAGENTS"] = "材料：|n",
  ["SPELL_RECAST_TIME_CHARGES"] = "%d次充能",
  ...
  ["STAT_ARMOR_PENETRATION"] = "护甲穿透等级",
  ["STAT_ATTACK_POWER"] = "攻击强度提高%d点",
  ["STAT_AVERAGE_ITEM_LEVEL"] = "平均物品等级（全部）",
  ["STAT_AVERAGE_ITEM_LEVEL_EQUIPPED"] = "平均物品等级（已穿戴）",
  ["STAT_BLOCK"] = "格挡",
  ["STAT_BLOCK_RATING"] = "格挡等级",
  ["STAT_BLOCK_TOOLTIP"] = "格挡值提高%d",
  ["STAT_DEFENSE_RATING"] = "防御等级",
  ["STAT_DODGE"] = "躲闪",
  ["STAT_DODGE_RATING"] = "闪避等级",
  ["STAT_EXPERTISE"] = "精准等级",
  ["STAT_FORMAT"] = "%s：",
  ["STAT_HASTE_RATING"] = "急速等级",
  ["STAT_HIT_RATING"] = "命中等级",
  ["STAT_PARRY"] = "招架",
  ["STAT_PARRY_RATING"] = "招架等级",
  ["STAT_RESILIENCE"] = "韧性",
  ["STAT_SPELL_PENETRATION"] = "法术穿透",
  ["STAT_TEMPLATE"] = "%s状态",
  ...
  ["TRADESKILLS"] = "商业技能",
  ["TRADESKILL_CRAFT"] = "制作",
  ["TRADESKILL_CRAFT_ALL"] = "制作全部",
  ["TRADESKILL_FILTER_HAS_SKILL_UP"] = "可提升技能",
  ["TRADESKILL_FILTER_INVENTORY"] = "有原料",
  ["TRADESKILL_FIRST_MAKE"] = "制作一件以提升技能",
  ["TRADESKILL_HAVE_AND_MISSING"] = "拥有：%s；缺少：%s",
  ["TRADESKILL_HAVE_MATERIALS"] = "有原料",
  ["TRADESKILL_HAVE_NOT"] = "无法制造",
  ["TRADESKILL_LOG_FIRSTPERSON"] = "你制造了%s。",
  ["TRADESKILL_LOG_THIRDPERSON"] = "%s制造了%s。",
  ["TRADESKILL_NAME_HEADER"] = "专业：",
  ["TRADESKILL_QUEUE_PREFIX"] = "队列：",
  ["TRADESKILL_REAGENT"] = "原料：",
  ["TRADESKILL_RESULT_COUNTS"] = "数量：",
  ["TRADESKILL_SERVICE_LEARN"] = "配方",
  ["TRADESKILL_SERVICE_PASSIVE"] = "被动",
  ["TRADESKILL_SERVICE_STEP"] = "发展技能",
  ["TRADESKILL_SKILL_CURRENT_MAX"] = "当前：%d/%d",
  ["TRADESKILL_TOOLS"] = "工具：",
  ...
  ["TRAIN"] = "训练",
  ["TRAINABLE"] = "可训练",
  ["TRAINER_AVAILABLE"] = "你可以学习这些技能：",
  ["TRAINER_CANNOT_LEARN"] = "你无法学习这些：",
  ...
  ["TRAINER_FILTER_AVAILABLE"] = "可学习",
  ["TRAINER_FILTER_NOT_USABLE"] = "不可用",
  ["TRAINER_FILTER_UNAVAILABLE"] = "不可学习",
  ["TRAINER_FILTER_USABLE"] = "可用",
  ["TRAINER_GREETING_TEXT"] = "我可以教你一些东西。",
  ["TRAINER_LEARNABLE"] = "可以学习",
  ["TRAINER_LIST_AVAILABLE"] = "可学习",
  ["TRAINER_LIST_FILTER"] = "过滤",
  ["TRAINER_LIST_SP"] = "%d SP",
  ["TRAINER_LIST_UNAVAILABLE"] = "不可学习",
  ["TRAINER_MANA_COST"] = "法力消耗：|cffffffff%d|r",
  ["TRAINER_MANA_COST_PER_TIME"] = "法力消耗：|cffffffff%d，外加%d每秒|r",
  ["TRAINER_NOT_LEARNABLE"] = "无法学习",
  ["TRAINER_RANGE"] = "射程：|cffffffff%s (%d)|r",
  ["TRAINER_RELEARN"] = "再次学习",
  ...
  ["TRAINER_SERVICE_INFO"] = "施法时间：%s\n消耗：%s",
  ["TRAINER_SKILLS_LEARNED"] = "你已学会%d项新技能！",
  ["TRAINER_TRADE_SKILLS"] = "商业技能",
  ["TRAINER_UNAVAILABLE"] = "以下技能无法学习：",
  ["TRAINER_UNLEARNABLE"] = "目前无法学习",
  ["TRAINER_UNLEARN_TEXT"] = "你确定要遗忘%s吗？",
